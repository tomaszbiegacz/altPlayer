...
TEST(event_file, read_direct_single) {
...
TEST(event_file, read_direct_twice) {
  log_set_verbose(true);
  EXPECT_EQ(0, event_loop_global_init());
  const char* data = "123456";
...
TEST(event_file, read_intermediate_single) {
  log_set_verbose(true);
  EXPECT_EQ(0, event_loop_global_init());
  const char* data = "123456";
...
TEST(event_file, read_intermediate_many_noPadding) {
  log_set_verbose(true);
  EXPECT_EQ(0, event_loop_global_init());
  const char* data = "123456";
...
TEST(event_file, read_intermediate_many_padding) {
  log_set_verbose(true);
  EXPECT_EQ(0, event_loop_global_init());
...
TEST(event_file, read_intermediate_header) {
  log_set_verbose(true);
  EXPECT_EQ(0, event_loop_global_init());
  const char* data = "123456123456";
...
TEST(event_file, read_intermediate_header_many) {
  log_set_verbose(true);
  EXPECT_EQ(0, event_loop_global_init());
  const char* data = "123456123456";
